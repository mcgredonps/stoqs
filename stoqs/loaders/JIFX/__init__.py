...
__copyright__ = '2016'
__license__   = 'GPL v3'
__contact__   = 'mcgredo at nps.edu'

'''
Contains class for common routines for loading all ardu data. ArduPilot
is a small uav vehicle autopilot that logs data in a CSV format. It's
used in the swarming UAV project.
...
class ARDULoader(LoadScript):
    '''
    Common routines for loading all ARDU data
    '''
    brownish = {'ardu':       '8c510a',
                'tethys':       'bf812d',
                'daphne':       'dfc27d',
                'fulmar':       'f6e8c3',
                'waveglider':   'c7eae5',
    ...
    def loadARDU(self, stride=None):
        '''
        Ardu specific load functions
        '''
        pName = 'ardu'
